...
function [ ret ] = ext_minutiae( img, display_flag )
    if nargin==1
        display_flag=1;
    end
...
%     figure;imshow(binim);title('binim');
%     figure;imshow(mask);title('mask');
%     figure;imshow(orient_img);title('orient_img');
%     figure;imshow(orient_img);title('orient_img_m');
    % Making Mask -------------------------------------------------------------
