...
function [EER, OP,FAR,FRR,x]=EER_DET_conf(clients,imposteurs,OPvalue,pas0)
...
% ROC curve
figure(2);
plot (FAR,100-FRR,'r',[0 40],[100 60],'b');
...
h = plot(FRR/100,FAR/100,'r',[0 1],[0 1],'b');
hold on; plot(EERplot/100,EERplot/100,'ok');
hold on; plot(FRR(tmpOP)/100,FAR(tmpOP)/100,'xk');
title ('DET curve');